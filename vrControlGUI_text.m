classdef vrControlGUI < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        useTrainingMode                 matlab.ui.control.CheckBox
    ...
    methods (Access = private)
        ...
        function out = generateOutputStructure(app)
            ...
            out.useTrainingMode = app.useTrainingMode.Value;
    ...
    methods (Access = private)
        ...
        function startupFcn(app)
            ...
            app.useTrainingMode.Value = vrControlPersistent('useTrainingMode');
        ...
        function loadSettingsButtonPushed(app, event)
            ...
            app.useTrainingMode.Value = vrControlPersistent('useTrainingMode',settings.useTrainingMode);
        ...
        function runExperimentButtonPushed(app, event)
            settings = generateOutputStructure(app);
            if isempty(settings.animalName)
                msg = 'Cannot start an experiment without defining animal name!';
                presentMessage(app, msg, 2)
                highlightComponent(app, 'animalName', 'BackgroundColor')
                return 
            end
            delete(app)
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            % Create useTrainingMode
            app.useTrainingMode = uicheckbox(app.UIFigure);
            app.useTrainingMode.Text = 'Use Training Mode';
            app.useTrainingMode.Position = [6 313 123 22];
            app.useTrainingMode.Value = true;
